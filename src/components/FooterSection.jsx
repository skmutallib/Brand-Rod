        ...
        <footer className="bg-black py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <a href="/" aria-label="go home" className="mx-auto block size-fit">
                    <img src="/brandrod-logo.svg" alt="" className='text-white' />
                </a>
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    {links.map((link, index) => (
                        <a
                            key={index}
                            href={link.href}
                            className="block text-gray-400 duration-150 hover:text-white">
                ...
                <span className="block text-center text-sm text-gray-400"> © {new Date().getFullYear()} Tailark, All rights reserved</span>
            </div>
        </footer>
    );
}